...
const Copyright=({dim})=>{
    ...
    return (
        ...
        <motion.footer className="align-items-center textpop copyright">
                {(<span>&copy; 2024</span>)}<span className="nav-item px-2 text-primary"><motion.span variants={Variants} animate="designer"><Link to="/about" className="Designer" 
               >{(<span style={{textTransform:"none", fontStyle:"italic"}} className="textpop fw-bold motion3">EATECH</span>)}
                    </Link></motion.span></span>
                    { w>430 && (<><span className="px-2 nav-link border-0"><Link to="" target="_blank">
                ...
                <span className="px-2 nav-link border-0"><Link to="" target="_blank" variants={svgVariants} initial="hidden" animate="visible">
                ...
                <span className="px-2 nav-link border-0"><Link to="" target="_blank">
